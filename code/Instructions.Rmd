...
- I am going to map mammal richness and state income and see which effects state park visits the most.  Do parks in states with higher incomes get more visits (more money to travel and have fun) or states with higher mammal richness because there is more interesting animals to see?
...
fips < select(fips, state:state_name)
?tigris

#need to join the tab data (park visits) with the sf object (state income)

stateincome.parkvisits <- left_join(state.income, park.visits, by=())
